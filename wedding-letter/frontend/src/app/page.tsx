    ...
    <div className="selection:bg-[#F9EBE6]">
      ...
      <main className="bg-white text-theme-primary">
          ...
          <div className="landing-shell relative grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_460px]">
            <div className="space-y-7">
              ...
              <div className="space-y-5">
                ...
                <h1 className="serif-font text-4xl leading-[1.2] font-light text-theme-brand md:text-6xl">
                  감성은 살리고,
                  <br />
                  제작은 더 빠르게.
                </h1>
        ...
        <section id="services" className="landing-section border-y border-warm bg-[#fdfbf9] py-16 md:py-24">
          <div className="landing-shell">
            <div className="mb-10 md:mb-14">
              ...
              <h2 className="serif-font mt-3 text-3xl font-light text-theme-brand md:text-5xl">핵심 서비스 특징</h2>
          ...
          <div className="landing-shell">
            <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <h2 className="serif-font mt-3 text-3xl font-light text-theme-brand md:text-5xl">템플릿 갤러리</h2>
              </div>
              <button className="btn-cta-secondary" type="button" onClick={goToEditorWithGuard}>
                전체 템플릿 보기
              </button>
        ...
        <section id="reviews" className="landing-section bg-[#fdfaf7] py-16 md:py-24">
          <div className="landing-shell">
            <div className="mb-9 md:mb-12">
              ...
              <h2 className="serif-font mt-3 text-3xl font-light text-theme-brand md:text-5xl">고객 후기</h2>
        ...
        <section className="landing-section border-t border-warm bg-white py-16 text-center md:py-20">
          <div className="landing-shell">
            <h2 className="serif-font text-3xl font-light text-theme-brand md:text-5xl">지금, 우리만의 청첩장을 시작하세요</h2>
